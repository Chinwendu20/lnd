...
func (*ListSweepsResponse_TransactionIDs) Descriptor() ([]byte, []int) {
	return file_walletrpc_walletkit_proto_rawDescGZIP(), []int{49, 0}
}
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xd6, 0x01, 0x0a, 0x18, 0x42, 0x75, 0x6d, 0x70, 0x46,
	...
	0x61, 0x6e, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x65, 0x61, 0x64, 0x6c,
	0x69, 0x6e, 0x65, 0x5f, 0x64, 0x65, 0x6c, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0d, 0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x12, 0x29,
	0x0a, 0x10, 0x73, 0x74, 0x61, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x66, 0x65, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x69,
	0x6e, 0x67, 0x46, 0x65, 0x65, 0x72, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x69, 0x6d, 0x6d,
	...
	0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x22,
	0x33, 0x0a, 0x19, 0x42, 0x75, 0x6d, 0x70, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x43, 0x6c, 0x6f, 0x73,
	0x65, 0x46, 0x65, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06,
	...
	0x5f, 0x50, 0x32, 0x54, 0x52, 0x10, 0x01, 0x32, 0x95, 0x12, 0x0a, 0x09, 0x57, 0x61, 0x6c, 0x6c,
	...
	0x12, 0x3d, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x63, 0x61, 0x6e, 0x12, 0x18, 0x2e, 0x77, 0x61, 0x6c,
	...
	0x2e, 0x52, 0x65, 0x73, 0x63, 0x61, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_walletrpc_walletkit_proto_goTypes = []interface{}{
	...
	nil,                                       // 66: walletrpc.RescanRequest.OutpointsEntry
	...
	(*lnrpc.Utxo)(nil),               // 69: lnrpc.Utxo
	(*lnrpc.OutPoint)(nil),           // 70: lnrpc.OutPoint
	(*signrpc.TxOut)(nil),            // 71: signrpc.TxOut
	(lnrpc.CoinSelectionStrategy)(0), // 72: lnrpc.CoinSelectionStrategy
	(*lnrpc.ChannelPoint)(nil),       // 73: lnrpc.ChannelPoint
	(*lnrpc.TransactionDetails)(nil), // 74: lnrpc.TransactionDetails
	(*signrpc.KeyLocator)(nil),       // 75: signrpc.KeyLocator
	(*signrpc.KeyDescriptor)(nil),    // 76: signrpc.KeyDescriptor
	(*lnrpc.Transaction)(nil),        // 77: lnrpc.Transaction
}
var file_walletrpc_walletkit_proto_depIdxs = []int32{
	66, // 0: walletrpc.RescanRequest.outpoints:type_name -> walletrpc.RescanRequest.OutpointsEntry
	69, // 1: walletrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	70, // 2: walletrpc.LeaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	70, // 3: walletrpc.ReleaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	...
	71, // 18: walletrpc.SendOutputsRequest.outputs:type_name -> signrpc.TxOut
	72, // 19: walletrpc.SendOutputsRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	70, // 20: walletrpc.PendingSweep.outpoint:type_name -> lnrpc.OutPoint
	...
	70, // 23: walletrpc.BumpFeeRequest.outpoint:type_name -> lnrpc.OutPoint
	73, // 24: walletrpc.BumpForceCloseFeeRequest.chan_point:type_name -> lnrpc.ChannelPoint
	74, // 25: walletrpc.ListSweepsResponse.transaction_details:type_name -> lnrpc.TransactionDetails
	67, // 26: walletrpc.ListSweepsResponse.transaction_ids:type_name -> walletrpc.ListSweepsResponse.TransactionIDs
	57, // 27: walletrpc.FundPsbtRequest.raw:type_name -> walletrpc.TxTemplate
	58, // 28: walletrpc.FundPsbtRequest.coin_select:type_name -> walletrpc.PsbtCoinSelect
	2,  // 29: walletrpc.FundPsbtRequest.change_type:type_name -> walletrpc.ChangeAddressType
	72, // 30: walletrpc.FundPsbtRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	59, // 31: walletrpc.FundPsbtResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	70, // 32: walletrpc.TxTemplate.inputs:type_name -> lnrpc.OutPoint
	68, // 33: walletrpc.TxTemplate.outputs:type_name -> walletrpc.TxTemplate.OutputsEntry
	70, // 34: walletrpc.UtxoLease.outpoint:type_name -> lnrpc.OutPoint
	59, // 35: walletrpc.ListLeasesResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	5,  // 36: walletrpc.WalletKit.ListUnspent:input_type -> walletrpc.ListUnspentRequest
	7,  // 37: walletrpc.WalletKit.LeaseOutput:input_type -> walletrpc.LeaseOutputRequest
	9,  // 38: walletrpc.WalletKit.ReleaseOutput:input_type -> walletrpc.ReleaseOutputRequest
	64, // 39: walletrpc.WalletKit.ListLeases:input_type -> walletrpc.ListLeasesRequest
	11, // 40: walletrpc.WalletKit.DeriveNextKey:input_type -> walletrpc.KeyReq
	75, // 41: walletrpc.WalletKit.DeriveKey:input_type -> signrpc.KeyLocator
	12, // 42: walletrpc.WalletKit.NextAddr:input_type -> walletrpc.AddrRequest
	23, // 43: walletrpc.WalletKit.GetTransaction:input_type -> walletrpc.GetTransactionRequest
	17, // 44: walletrpc.WalletKit.ListAccounts:input_type -> walletrpc.ListAccountsRequest
	19, // 45: walletrpc.WalletKit.RequiredReserve:input_type -> walletrpc.RequiredReserveRequest
	21, // 46: walletrpc.WalletKit.ListAddresses:input_type -> walletrpc.ListAddressesRequest
	24, // 47: walletrpc.WalletKit.SignMessageWithAddr:input_type -> walletrpc.SignMessageWithAddrRequest
	26, // 48: walletrpc.WalletKit.VerifyMessageWithAddr:input_type -> walletrpc.VerifyMessageWithAddrRequest
	28, // 49: walletrpc.WalletKit.ImportAccount:input_type -> walletrpc.ImportAccountRequest
	30, // 50: walletrpc.WalletKit.ImportPublicKey:input_type -> walletrpc.ImportPublicKeyRequest
	32, // 51: walletrpc.WalletKit.ImportTapscript:input_type -> walletrpc.ImportTapscriptRequest
	37, // 52: walletrpc.WalletKit.PublishTransaction:input_type -> walletrpc.Transaction
	23, // 53: walletrpc.WalletKit.RemoveTransaction:input_type -> walletrpc.GetTransactionRequest
	40, // 54: walletrpc.WalletKit.SendOutputs:input_type -> walletrpc.SendOutputsRequest
	42, // 55: walletrpc.WalletKit.EstimateFee:input_type -> walletrpc.EstimateFeeRequest
	45, // 56: walletrpc.WalletKit.PendingSweeps:input_type -> walletrpc.PendingSweepsRequest
	47, // 57: walletrpc.WalletKit.BumpFee:input_type -> walletrpc.BumpFeeRequest
	49, // 58: walletrpc.WalletKit.BumpForceCloseFee:input_type -> walletrpc.BumpForceCloseFeeRequest
	51, // 59: walletrpc.WalletKit.ListSweeps:input_type -> walletrpc.ListSweepsRequest
	53, // 60: walletrpc.WalletKit.LabelTransaction:input_type -> walletrpc.LabelTransactionRequest
	55, // 61: walletrpc.WalletKit.FundPsbt:input_type -> walletrpc.FundPsbtRequest
	60, // 62: walletrpc.WalletKit.SignPsbt:input_type -> walletrpc.SignPsbtRequest
	62, // 63: walletrpc.WalletKit.FinalizePsbt:input_type -> walletrpc.FinalizePsbtRequest
	3,  // 64: walletrpc.WalletKit.Rescan:input_type -> walletrpc.RescanRequest
	6,  // 65: walletrpc.WalletKit.ListUnspent:output_type -> walletrpc.ListUnspentResponse
	8,  // 66: walletrpc.WalletKit.LeaseOutput:output_type -> walletrpc.LeaseOutputResponse
	10, // 67: walletrpc.WalletKit.ReleaseOutput:output_type -> walletrpc.ReleaseOutputResponse
	65, // 68: walletrpc.WalletKit.ListLeases:output_type -> walletrpc.ListLeasesResponse
	76, // 69: walletrpc.WalletKit.DeriveNextKey:output_type -> signrpc.KeyDescriptor
	76, // 70: walletrpc.WalletKit.DeriveKey:output_type -> signrpc.KeyDescriptor
	13, // 71: walletrpc.WalletKit.NextAddr:output_type -> walletrpc.AddrResponse
	77, // 72: walletrpc.WalletKit.GetTransaction:output_type -> lnrpc.Transaction
	18, // 73: walletrpc.WalletKit.ListAccounts:output_type -> walletrpc.ListAccountsResponse
	20, // 74: walletrpc.WalletKit.RequiredReserve:output_type -> walletrpc.RequiredReserveResponse
	22, // 75: walletrpc.WalletKit.ListAddresses:output_type -> walletrpc.ListAddressesResponse
	25, // 76: walletrpc.WalletKit.SignMessageWithAddr:output_type -> walletrpc.SignMessageWithAddrResponse
	...
	4,  // 93: walletrpc.WalletKit.Rescan:output_type -> walletrpc.RescanResponse
...
func file_walletrpc_walletkit_proto_init() {
	...
	file_walletrpc_walletkit_proto_msgTypes[49].OneofWrappers = []interface{}{
		(*ListSweepsResponse_TransactionDetails)(nil),
		(*ListSweepsResponse_TransactionIds)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[52].OneofWrappers = []interface{}{
